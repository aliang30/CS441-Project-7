...
public class Truck2Difficulty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truck2_difficulty);
    ...
    public void openActivity2() {
        Intent intent = new Intent (this, Truck2Hard.class);
        startActivity(intent);
    }
}
