...
public class BlackCarDifficulty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_black_car_difficulty);
    ...
    public void openActivity2() {
        Intent intent = new Intent (this, BlackCarHard.class);
        startActivity(intent);
    }
}
