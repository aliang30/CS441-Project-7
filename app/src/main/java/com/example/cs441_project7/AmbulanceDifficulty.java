...
public class AmbulanceDifficulty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance_difficulty);
    ...
    public void openActivity2() {
        Intent intent = new Intent (this, AmbulanceHard.class);
        startActivity(intent);
    }
}
