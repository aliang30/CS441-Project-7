...
public class OrangeCarDifficulty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orange_car_difficulty);
    ...
    public void openActivity2() {
        Intent intent = new Intent (this, OrangeCarHard.class);
        startActivity(intent);
    }
}
